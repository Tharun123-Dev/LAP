...
// ── Geolocation helper ───────────────────────────────────────────────────────
/**
 * Returns { latitude, longitude } from the browser Geolocation API.
 * Rejects with a user-readable message if denied or unavailable.
 */
...
/**
 * checkInApi — sends latitude + longitude to backend.
 * If is_wfh is true, location is optional (backend skips validation).
 */
