    ...
    <div style={{ maxWidth: '720px', margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          ...
          <h2 style={{ margin: 0, fontSize: '20px', fontWeight: 700, color: '#111' }}>
            ...
            {unread > 0 && (
              <span style={{
                ...
                borderRadius: '999px', fontSize: '12px', padding: '2px 8px', fontWeight: 600,
              }}>
                {unread} unread
              </span>
            )}
        ...
        {unread > 0 && (
          <button onClick={handleMarkAllRead} style={{
            ...
            background: '#fff', cursor: 'pointer', fontSize: '13px', color: '#374151', fontWeight: 500,
          }}>
            ✓ Mark all read
          </button>
        )}
      ...
      {loading ? (
        ...
        <div style={{
          ...
          background: '#fafafa', borderRadius: '12px', border: '1px dashed #e5e7eb',
        }}>
            ...
            <div key={notif.id} style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', gap: '8px' }}>
                  <p style={{
                    margin: 0, fontSize: '14px', fontWeight: notif.is_read ? 500 : 700,
                ...
                <p style={{
                  margin: '4px 0 0', fontSize: '13px', color: '#555', lineHeight: 1.5,
                }}>
                  {notif.body}
                </p>
              </div>
              ...
              <div style={{ display: 'flex', gap: '6px', flexShrink: 0 }}>
                {!notif.is_read && (
                  <button onClick={() => handleMarkRead(notif.id)} title="Mark as read" style={{
                    background: '#e0e7ff', border: 'none', borderRadius: '6px',
                    padding: '4px 8px', cursor: 'pointer', fontSize: '12px', color: '#4338ca',
                  }}>
                    ✓
                  </button>
                )}
                <button onClick={() => handleDelete(notif.id)} title="Delete" style={{
