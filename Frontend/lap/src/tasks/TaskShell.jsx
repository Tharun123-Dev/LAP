  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 font-sans flex transition-colors duration-300">
      ...
      <div className="flex-1 lg:pl-64 flex flex-col min-w-0">
        {/* Task Module Topbar */}
        <header className="sticky top-0 z-30 flex items-center justify-between px-6 py-4 bg-white/70 dark:bg-slate-950/70 border-b border-slate-200/80 dark:border-slate-800/80 backdrop-blur-md">
